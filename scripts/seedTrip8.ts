...
const sundayScheduleRev = [
    ...
    { hour: 10, minutes: [12, 33, 46] },
    { hour: 11, minutes: [11, 24, 36] },
    { hour: 12, minutes: [0, 12, 24] },
    { hour: 13, minutes: [0, 12, 24] },
    { hour: 14, minutes: [0, 11, 23] },
    { hour: 15, minutes: [11, 23, 35] },
    { hour: 16, minutes: [11, 23, 35] },
    { hour: 17, minutes: [11, 23, 35] },
    { hour: 18, minutes: [0, 12, 24] },
    { hour: 19, minutes: [5, 20, 35] },
    { hour: 20, minutes: [5, 19, 34] },
    { hour: 21, minutes: [4, 19, 36] }
  ];